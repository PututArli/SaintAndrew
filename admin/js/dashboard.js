...
const DEFAULT_STASI_DATA = {
  ...
  'marga-lestari': {
    ...
    sejarah: "Berbeda dengan Marga Agung, umat di sini bukan dari transmigrasi Merapi, melainkan daerah bukaan tahun 1962. Awalnya bagian dari Gedung Meneng I. Tokoh perintisnya adalah Bapak Ayub dan Bapak Aliun. Gereja pertama dibangun tahun 1968 dengan semangat Persatuan Konten, hasil gotong royong umat Katolik dan warga Muslim setempat. Nama pelindung Santa Maria terinspirasi dari Sendang Sono, ditandai dengan penanaman potongan jari patung Bunda Maria Sendang Sono di bawah altar gereja lama.",
    daftar_ketua: ["Kirin Siswo Soemarto","Ignasius Sis Mardji","Robertus Soeryo Martono","Yusuf Basuki","Gabriel Irawan Edi Soeyono","Robertus Yunarto","Wiryo Suprayogi (2005)","Robertus Yunarto (2008)","Antonius Hadi Susanto (2011)","Yohanes Seh Hadi (2014)","Hariyadi (2017)","Yohanes Seh Hadi (2020)","Antonius Imam S (2023)","Antonius Suhartono (2025)"],
