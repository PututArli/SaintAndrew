(function () {
  ...
  style.textContent =
    '#sa-page-loader{position:fixed;inset:0;z-index:40;display:flex;align-items:center;justify-content:center;background:#F5F3EF;transition:opacity '+FADE_MS+'ms ease;pointer-events:none}' +
