...
if (!customElements.get('page-hero')) {
    customElements.define('page-hero', class extends HTMLElement {
        connectedCallback() {
...
if (!customElements.get('callout-banner')) {
    customElements.define('callout-banner', class extends HTMLElement {
        connectedCallback() {
...
if (!customElements.get('cross-ornament')) {
    customElements.define('cross-ornament', class extends HTMLElement {
        connectedCallback() {
...
window.renderCrossOrnament = window.renderCrossOrnament || function(size = 'md', extraClass = '', icon = '✝', style = '') {
    const sizeMap = {
        xs: 'w-6 h-6 text-[10px] rounded-md',
        sm: 'w-8 h-8 text-xs rounded-lg',
        md: 'w-10 h-10 text-base rounded-xl',
...
window.renderAestheticDivider = window.renderAestheticDivider || function(extraClass = '', customStyle = '') {
...
window.renderInfoBadge = window.renderInfoBadge || function(icon = '✝', text = '', variant = 'gold') {
