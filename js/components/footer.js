const SOCIAL_LINKS = {
    instagram: "https://www.instagram.com/parokimargaagung/", 
    facebook: "#",  
    youtube: "#"    
};
...
class ModernFooter extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
        <footer class="glass-nav text-white text-center py-6 mt-auto">
        <div class="flex justify-center space-x-6 mb-4">
            <a href="${SOCIAL_LINKS.instagram}" target="_blank" class="hover:text-blue-300 transition-colors duration-300" title="Instagram Paroki">
            ...
            <a href="${SOCIAL_LINKS.facebook}" target="_blank" class="hover:text-blue-300 transition-colors duration-300" title="Facebook Paroki">
            ...
            <a href="${SOCIAL_LINKS.youtube}" target="_blank" class="hover:text-blue-300 transition-colors duration-300" title="YouTube Paroki">
        ...
        <p class="text-sm opacity-80">&copy; 2026 Rafael Putut Arli - 2417051042</p>
        </footer>
        `;
    }
}
