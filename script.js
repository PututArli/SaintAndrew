...
function openStasiModal(id) {
    ...
    content.innerHTML = `
        <h2 class="text-3xl font-bold text-blue-900 mb-2">${data.title}</h2>
        <p class="text-blue-600 font-bold mb-6 italic">Pelindung: ${data.patron}</p>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="md:col-span-2">
                <h4 class="font-bold text-blue-800 mb-2 border-l-4 border-blue-800 pl-3">Sejarah Singkat</h4>
                <p class="text-gray-700 text-justify leading-relaxed">${data.history}</p>
            </div>
            <div class="relative">
                <div class="sticky top-0 bg-white/60 p-5 -mt-5 rounded-2xl backdrop-blur-md border border-white/50 shadow-sm z-10">
